...
def build_full_report_final():
    ...
    doc = Document()
    print("Building FULL 35+ PAGE REPORT...")

    # Title Page Fix (Centered, no stretching)
    ...
    # Mapping lines to Sections (approximate based on backup_content.txt)
    sections = [
        ("Remerciements", lines[10:17]),
        ("Résumé", lines[17:22]),
        ...
        ("4.3 Moteur de compatibilité", lines[127:134] + [lines[251]]),
        ("4.4 Système de collecte automatique", lines[136:143] + [lines[249]]),
        ...
        ("5.6 Perspectives techniques détaillées", lines[189:194] + [lines[253]]),
    ...
    for title, content in sections:
        ...
        if "Planning" in title: 
            ...
            data = [["Phase", "Tâches", "Responsable", "Durée"], ["Analyse", "UML & Besoins", "Binôme", "2 sem."], ["Back-end", "API & Scrapers", "Salmane", "4 sem."], ["Front-end", "UI", "Ghali", "4 sem."], ["Validation", "Tests", "Binôme", "2 sem."]]
        ...
        if "Architecture" in title and "Conception" in title: add_fig(os.path.join(puml_dir, "class.png"), "Diagramme de classes")
        ...
        if "compatibilité" in title: add_fig(os.path.join(puml_dir, "sequence_compatibility.png"), "Vérification des règles")
    ...
    doc.save(final_path)
    print("Full Master Report Built Successfully.")

if __name__ == "__main__":
    build_full_report_final()
