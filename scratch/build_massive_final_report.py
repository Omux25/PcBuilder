...
def build_massive_final_report():
    ...
    with open(r'c:\Headquarters\Projects\PcBuilder\scratch\full_expansion_content.md', 'r', encoding='utf-8') as f:
        expansion = f.read()

    doc = Document()
    print("Building MASSIVE 45-50 PAGE REPORT...")
    ...
    sections = [
        ...
        ("1.3 Analyse du Marché Marocain", extract_md_section("## Section 1")), # EXPANDED
        ...
        ("2.4 Planning Détaillé (GANTT)", []),
        ("Chapitre 3 : Analyse et Conception", []),
        ("3.1 Choix Techniques", lines[91:96]),
        ("3.2 Architecture du Design System", extract_md_section("## Section 2")), # EXPANDED
        ...
        ("4.3 Moteur de compatibilité & Algorithmes", lines[119:126] + extract_md_section("## Section 3")), # EXPANDED
        ...
        ("5.1 Matrice de Tests Détaillée", [
            ...
            "TC-01 | Auth | Login Admin | Success",
            "TC-02 | Compatibility | CPU Socket Check | Success",
            "TC-03 | Scraper | Price Extraction | Success",
            "TC-04 | Mapping | DNA Matcher Score | Success",
            "TC-05 | UI | Responsive Layout | Success"
        ]),
        ("5.2 Tests de Charge et Apport", lines[159:171]),
        ("Conclusion et perspectives", lines[184:191]),
        ("Bibliographie", lines[192:206]),
        ("Annexes", lines[207:228] + extract_md_section("## Section 4") + extract_md_section("## Section 5")) # EXPANDED
    ]
    ...
    doc.save(final_path)
    print("Massive 45+ Page Report Built.")

if __name__ == "__main__":
    build_massive_final_report()
