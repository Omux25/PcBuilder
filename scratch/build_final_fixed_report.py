...
def build_final_fixed_report():
    ...
    doc = Document()
    print("Building FINAL FIXED REPORT...")
    ...
    sections = [
        ...
        ("3.2 Modélisation UML : Cas d'utilisation", lines[108:110]),
        ("3.3 Architecture et Diagramme de Classes", lines[110:112]),
        ("3.4 Conception de la Base de Données", lines[112:114]),
    ...
    for title, content in sections:
        if "Chapitre" in title or title in ["Conclusion et perspectives", "Bibliographie", "Annexes"]:
            ...
            doc.add_heading(title, level=1)
            # Add a clean, simple TOC list instead of a placeholder
        ...
        for line in content:
            txt = line.strip()
            # DEDUPLICATION: Skip if paragraph exactly matches header
    ...
    doc.save(final_path)
    print("Final Fixed Report Built.")

if __name__ == "__main__":
    build_final_fixed_report()
